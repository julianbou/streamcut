...
--   * Delta feeds for watch progress / watched items / library are
--     append-only event logs with operations 'upsert' and 'delete'.
-- ============================================================================
...
-- ============================================================================
-- Added 2026-09-22 (also shipped as patch-library-delta-devices-membership.sql):
-- library delta sync, device sessions, and the membership stub.
-- ============================================================================
