    ...
    item {
        ...
        SettingsSection(
            ...
            SettingsGroup(isTablet = isTablet) {
                ...
                // Poster hover previews are off in the clipper build, so this
                // page would only offer settings for something that never happens.
                if (isDesktop && AppFeaturePolicy.viewingChromeEnabled) {
                    SettingsGroupDivider(isTablet = isTablet)
                    SettingsNavigationRow(
