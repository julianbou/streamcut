...
private fun PlayerControlsState.toControlsJson(isFullscreen: Boolean): String =
    buildString {
        ...
        append(',')
        appendJsonField("showClip", showClip)
        append(',')
        appendJsonField("clipRunning", clipRunning)
        append(',')
        appendJsonField("clipProgress", clipProgress)
        append(',')
        appendJsonField("clipStatusMessage", clipStatusMessage)
        append(',')
        ...
        append(',')
        appendJsonField("subtitleSearchOpen", subtitleSearchOpen)
        append(',')
...
private fun StringBuilder.appendClipJobItemJson(item: PlayerClipJobItem) {
    append('{')
    appendJsonField("rangeLabel", item.rangeLabel)
    append(',')
    appendJsonField("durationLabel", item.durationLabel)
    append(',')
    appendJsonField("statusKind", item.statusKind)
    append(',')
    appendJsonField("statusMessage", item.statusMessage)
    append(',')
    appendJsonField("progress", item.progress)
    append(',')
    appendJsonField("isActive", item.isActive)
    append(',')
    appendJsonField("canReveal", item.canReveal)
    append('}')
}

private fun StringBuilder.appendClipLibraryItemJson(item: PlayerClipLibraryItem) {
    append('{')
    appendJsonField("id", item.id)
    append(',')
    appendJsonField("fileName", item.fileName)
    append(',')
    appendJsonField("rangeLabel", item.rangeLabel)
    append(',')
    appendJsonField("durationLabel", item.durationLabel)
